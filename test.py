...
def main():
    ...
    mymotortest.motor_go(False, "Full" , 200, .005, True, .05)
    time.sleep(1)
    ...
    mymotortest.motor_go(True, "Full" , 20, 1, True, .05)
    time.sleep(1)
    input("TEST: Press <Enter> to continue  full initdelay Test5")
    mymotortest.motor_go(True, "Full" , 180, .01, True, .05)
    time.sleep(1)
    ...
    mymotortest.motor_go(False, "Half" , 800, .005, True, .05)
    time.sleep(1)
    input("TEST: Press <Enter> to continue 1/ 4 Test1")
    mymotortest.motor_go(False, "1/4" , 1600, .005, True, .05)
    time.sleep(1)
    input("TEST: Press <Enter> to continue 1/8 Test1")
    mymotortest.motor_go(False, "1/8" , 3200, .005, True, .05)
    time.sleep(1)
    input("TEST: Press <Enter> to continue  1/16 Test1")
    mymotortest.motor_go(False, "1/16" , 6400, .005, True, .05) 
    time.sleep(1)
